...
plt.tight_layout()
plt.savefig('plots/anomaly_by_user_distribution.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots/boxplot_top_features.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots/anomaly_by_weekday.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots/anomaly_by_month.png')
plt.close()
